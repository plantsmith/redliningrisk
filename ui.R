             ...
             sidebarLayout(
               sidebarPanel(
                 ...
                 selectInput(inputId  = "variable_name",
                             ...
                             selected = "canopy_pct",
                             multiple = FALSE),
                 p(em("'Canopy %' = % of area covered by tree canopy"),
                   style = "text-align: left; font-size:10px"),
                 p(em("'Poverty %' = % of population living 2x below the federal poverty level"),
                   style = "text-align: left; font-size:10px"),
                 p(em("'Heat Related ER Visits' = daily excess number of emergency room visits during an extreme heat day"),
                   style = "text-align: left; font-size:10px"),
